...
X_train = train_data[['SepalLengthCm', 'SepalWidthCm', 'PetalLengthCm', 'PetalWidthCm']].values
Y_train = train_data[['Species']].values


valid_data = pd.read_pickle('./data/valid.pickle')
X_valid = valid_data[['SepalLengthCm', 'SepalWidthCm', 'PetalLengthCm', 'PetalWidthCm']].values
Y_valid = valid_data[['Species']].values

test_data = pd.read_pickle('./data/test.pickle')
X_test = test_data[['SepalLengthCm', 'SepalWidthCm', 'PetalLengthCm', 'PetalWidthCm']].values
...
print('Accuracy:', accuracy(y_pred, Y_valid), '%')
